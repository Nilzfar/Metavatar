...
public class LogInManager : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField] TMPro.TextMeshProUGUI m_screenText;
    [SerializeField] ulong m_userId;
    [SerializeField] GameObject photonUserPrefab = default;
    ...
    void InstantiateNetworkedAvatar()
    {
        ...
        GameObject myAvatar = PhotonNetwork.Instantiate(photonUserPrefab.name, _spawnPoint.transform.position, Quaternion.identity, 0, objects);
